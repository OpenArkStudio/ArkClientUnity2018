...
namespace ARKGame
{
    public static class AssetUtility
    {
        ...
        {
            return string.Format("Assets/GameMain/Localization/{0}/Dictionaries/{1}.xml", ARKGameEntry.Localization.Language.ToString(), assetName);
        }

        public static string GetFontAsset(string assetName)
        {
            return string.Format("Assets/GameMain/Localization/{0}/Fonts/{1}.ttf", ARKGameEntry.Localization.Language.ToString(), assetName);
        }
