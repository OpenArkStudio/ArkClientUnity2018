...
public class DialogForm : UGuiForm
{
    ...
    private void RefreshConfirmText(string confirmText)
    {
        ...
        {
            confirmText = ARKGameEntry.Localization.GetString("Dialog.ConfirmButton");
        }
    ...
    private void RefreshCancelText(string cancelText)
    {
        ...
        {
            cancelText = ARKGameEntry.Localization.GetString("Dialog.CancelButton");
        }
    ...
    private void RefreshOtherText(string otherText)
    {
        ...
        {
            otherText = ARKGameEntry.Localization.GetString("Dialog.OtherButton");
        }
