...
public static class SoundExtension
{
    ...
    public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
    {
        ...
        IDataTable<DRMusic> dtMusic = ARKGameEntry.DataTable.GetDataTable<DRMusic>();
    ...
    {
        IDataTable<DRSound> dtSound = ARKGameEntry.DataTable.GetDataTable<DRSound>();
    ...
    {
        IDataTable<DRUISound> dtUISound = ARKGameEntry.DataTable.GetDataTable<DRUISound>();
    ...
    public static void Mute(this SoundComponent soundComponent, string soundGroupName, bool mute)
    {
        ...
        ARKGameEntry.Setting.SetBool(string.Format(Constant.Setting.SoundGroupMuted, soundGroupName), mute);
        ARKGameEntry.Setting.Save();
    }
    ...
    public static void SetVolume(this SoundComponent soundComponent, string soundGroupName, float volume)
    {
        ...
        ARKGameEntry.Setting.SetFloat(string.Format(Constant.Setting.SoundGroupVolume, soundGroupName), volume);
        ARKGameEntry.Setting.Save();
    }
}
